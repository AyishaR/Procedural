...
torchrun --rdzv-backend=c10d --rdzv-endpoint=localhost:$MASTER_PORT --nproc_per_node=$SLURM_GPUS_ON_NODE main.py \
    ...
    --notes "late lever via proj/fc2 only: timm random with blocks 9-11 proj x9.06/21.16/57.91 and fc2 x9.42/27.47/81.71 (ftbrho's v*proj and fc2 products), write ratio 1.4 in blocks 9-11; loud and slow" \
