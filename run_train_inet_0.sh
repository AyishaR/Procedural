#!/bin/bash
#SBATCH --job-name inet_random
#SBATCH --partition lmbhiwidlc_gpu-rtx2080
#SBATCH --nodes 1
#SBATCH --gres=gpu:4
#SBATCH --time 23:59:59
#SBATCH -o /home/dawooda/code/procedural/Procedural/logs/inet_%j_%x.out
#SBATCH -e /home/dawooda/code/procedural/Procedural/logs/inet_%j_%x.err # STDERR
...
for i in 0; do
    torchrun --standalone --nproc_per_node=$SLURM_GPUS_ON_NODE main.py \
        ...
        --data_set "IMNET" \
        --output_dir "/home/dawooda/code/procedural/Procedural/results_random_inet/s$i" \
        --enable_wandb true \
        --project "imagenet" \
        --slurm_id 10000001 \
        --seed $i
